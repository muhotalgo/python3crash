import gokkwang.dbinfo as dbinfo
...
class SungJukDAO:
    ...
    def select_sungjuk():
        """
        sungjuk 테이블에서 모든 성적(번호/이름/국어/영어/수학/등록일) 데이터 가져옴
        :return: 조회된 성적데이터 객체
        """
