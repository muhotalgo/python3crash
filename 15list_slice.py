...
print(f'{cardnum} {cardtype} {cardname}')
...
a.extend(b)
# a = a + b     되긴 하지만 의미를 명확하게 하기 위해 쓰지 않는 편이 좋다
print(a)
...
print('drive' in todo)  # False
print('shopping' in todo)  # True
...
for idx in range(1, 10+1):
    ...
    bloods.append(blood)
    # if bloods[idx] == 'A': acnt = acnt + 1
    # elif bloods[idx] == 'B': bcnt = bcnt + 1
    # elif bloods[idx] == 'AB': abcnt = abcnt + 1
    # elif bloods[idx] == 'O': ocnt = ocnt + 1
